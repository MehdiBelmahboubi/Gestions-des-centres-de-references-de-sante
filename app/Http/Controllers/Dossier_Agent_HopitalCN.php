...
class Dossier_Agent_HopitalCN extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dossiers_agent_hopital.index', compact('dossiers','patients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existingDossier = Dosspat::where('patiente_id', $patienteId)->first();

        if ($existingDossier) {
            
          return redirect()->route('dossiers.index')->with('error', 'cette patiente a déja un dossier !');
        }
        ...
        $dossier->patiente_id = $patienteId;
        $dossier->save();
    
        return redirect()->route('dossiers.index')->with('success', 'dossier pour la patiente a été ajouter avec succès !');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dossiers.index')->with('success', 'modifiaction réussite !');
